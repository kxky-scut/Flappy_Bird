...
**Goal:** 单文件 main.py，Python + Pygame 经典 Flappy Bird 游戏

**Architecture:** Bird 类（物理+渲染）、Pipe 类（移动+碰撞）、Game 类（主循环+状态机+计分+渲染），统一由 main() 入口驱动

**Tech Stack:** Python 3.12, Pygame

---

### Task 1: 安装 pygame 并创建项目骨架
...
- [ ] **Step 2: 创建 main.py 骨架，验证 pygame 能初始化窗口**
...
Expected: 窗口打开，显示标题和提示，按空格开始游戏

- [ ] **Step 4: Commit**

```bash
git add main.py && git commit -m "feat: implement Flappy Bird game"
```
